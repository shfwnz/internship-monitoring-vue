...
<template>
  <nav class="flex py-3 px-4 bg-white rounded-2xl">
    <div class="flex items-center justify-start">Logo</div>
      ...
      <NavigationMenu>
        <NavigationMenuList>
          <NavigationMenuItem>
            ...
            <NavigationMenuContent>
              <ul class="gap-3 p-0.5">
                <li v-for="link in profileMenu" :key="link.path">
